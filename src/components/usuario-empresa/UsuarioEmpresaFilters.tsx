/**
 * @file UsuarioEmpresaFilters.tsx
 * @description Barra de busqueda y filtros avanzados del CRUD de asignaciones usuario-empresa.
 */
...
import type { UsuarioEmpresaFilterState } from "@/types/pages/usuario-empresa-page.types";

interface UsuarioEmpresaFiltersProps {
  filters: UsuarioEmpresaFilterState;
  onChange: (filters: UsuarioEmpresaFilterState) => void;
  onApply: (filters?: UsuarioEmpresaFilterState) => void;
  actions?: ReactNode;
}

/** Filtros de asignaciones usuario-empresa con busqueda rapida y panel avanzado. */
export function UsuarioEmpresaFilters({ filters, onChange, onApply, actions }: UsuarioEmpresaFiltersProps) {
  const [expanded, setExpanded] = useState(false);

  const update = useCallback(
    (key: keyof UsuarioEmpresaFilterState, value: string) => {
